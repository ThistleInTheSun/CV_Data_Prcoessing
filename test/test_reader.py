...
class MyTestCase(unittest.TestCase):
    def test_is_recursive(self):
        from data_transforms.reader import ImageReader
    ...
    def test_VideoReader(self):
        from data_transforms.reader import VideoReader
